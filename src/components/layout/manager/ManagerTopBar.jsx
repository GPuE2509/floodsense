...
const pageTitles = {
  ...
  'system-notifications': { title: "DISPATCH SYSTEM NOTIFICATIONS", sub: "Send broadcast alerts to users" },
  'manage-guidelines': { title: "MANAGE EMERGENCY GUIDELINES", sub: "Update and manage rescue instructions" },
  ...
  'analytics-report': { title: "EXPORT CENTER", sub: "Export analytics and system reports" },
};
...
export default function ManagerTopBar({ activePage, collapsed, onOpenProfile, onNavigate, userName, avatarUrl = '' }) {
  ...
  const pageInfo = pageTitles[activePage] || pageTitles['community-reports'] || { title: "MANAGER", sub: "Management Portal" };
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          <div className="topbar-user" role="button" tabIndex={0} onClick={onOpenProfile} style={{ cursor: 'pointer' }}>
            ...
            <div style={{ minWidth: 0, overflow: 'hidden' }}>
              <div style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-primary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', fontFamily: 'var(--font-display)', letterSpacing: '0.02em', maxWidth: 120 }}>
                {userName || 'Manager'}
              </div>
